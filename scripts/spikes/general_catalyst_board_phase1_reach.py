#!/usr/bin/env python3
"""
AST-430 Phase 1: reach general_catalyst.com/jobs, dismiss consent if present, capture visible + a11y + meta.

Usage (repo root, PYTHONPATH=.):
  python3 scripts/spikes/general_catalyst_board_phase1_reach.py [--headed] [--out-dir DIR] [--url URL]
"""
...
DEFAULT_OUT = _ROOT / "debug/spikes/AST-430"
...
async def _run(url: str, out_dir: Path, headed: bool) -> None:
    meta: Dict[str, Any] = {
        "spike": "general_catalyst_board_phase1_reach",
        "linear_id": "AST-430",
        "target_url": url,

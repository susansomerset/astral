...
def save_candidate_data(
    ...
    *,
    ...
    # AST-1633 / AST-1649 / AST-1652 / AST-1655: catalog owns these context leaves — never library-merge SoT.
...
# Catalog-owned context leaves — never durable library-merge SoT (AST-1633 / AST-1649 / AST-1652 / AST-1655).
_CONTEXT_OPERATIVE_LEAVES = frozenset({"strengths", "bio_summary", "priorities", "deal_breakers"})

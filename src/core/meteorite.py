"""
Meteorite placeholder company ensure, legacy create, public land_meteorite (AST-1470 / AST-1493 / AST-1495),
and candidate-bound mailbox ingress via check_inbox (AST-1559).
...
per-row Ruth company_stem ensure → tracker.save_meteorite_job. check_inbox:
aliases → fetch → inline classify → fan-out staging rows → archive; no Gmail I/O
here — inbox owns fetch/archive. create_meteorite_job accepts optional stem= for
legacy callers. create_contact_meteorite (AST-1517 contact-task create) wraps
scrape-or-text → create.
"""

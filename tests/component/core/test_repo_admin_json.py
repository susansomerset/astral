...
class TestAst786AgentTaskRepoJsonSeed:
    """AST-786 UAT: populated agent_task repo JSON from UAT fixture (43 rows after AST-1015 + AST-1060).
    ...
    AST-1060 adds `qualify_meteorite`; AST-1015 adds `preamble_validate_response`.
    """

...
**UAT seed (AST-786 / AST-878 / AST-1015 / AST-1037 / AST-1055 / AST-1060):** populated **43**-row catalog (includes **`fetch_culture_pages`**, **`preamble_validate_response`**, **`simple_resume_parse`**, **`meteorite_like`**, **`meteorite_upshot`**, **`qualify_meteorite`**) — see **`docs/test-bible/data/database/agent_tasks.md`**.

...
| Plan Ready | Chuckles + Archie | **`validate-plan`** → **Plan Approved** (APPROVED) or **Plan Discuss** (REVISE); engineer stays assignee |
| Plan Discuss | Chuckles (Joan actor) + engineer | tagged discuss loop (`validate-plan` / plan reply); cap 2 → Archie (Linear: Susan); exit Plan Approved or Todo |

...
**Linear archived:** AST-340 2026-06-03

## Ledger

| when (PT) | ticket | phase | sha | subject |
|---|---|---|---|---|
| 2026-04-25 14:56 | AST-340 | docs | `55a6b9d08` | record implementation commit id for code review |
| 2026-04-25 14:56 | AST-340 | — | `fd74c0143` | retry routing, prior_states, dispatch from DB |
| 2026-04-25 14:59 | AST-340 | chore | `1a5feff6b` | add code review findings |
| 2026-04-25 15:06 | AST-340 | — | `e5bae93e0` | fix missing-ID log label; doc table naming |

## Epic — AST-340

_Archived: 2026-06-03 · Linear URL: https://linear.app/astralcareermatch/issue/AST-340/retry-bad-responses · Status at archive: Done · Project: Astral Agent · Assignee: susan · Priority / estimate: High / —_
...
| | file | planned | actual |
|---|---|---|---|
| ✓ | `src/utils/config.py` | JOB_STATES, CONSULT_CONFIG, TRACKER_CONFIG,  | `fd74c0143` |
| ✓ | `src/data/database.py` | add sort_by + batch_call_mode columns; seed  | `fd74c0143` |
| ✓ | `src/core/tracker.py` | prior_states enforcement | `fd74c0143` |
| ✓ | `src/core/consult.py` | run_consult_task entry point; per-job valida | `e5bae93e0` `fd74c0143` |
| ✓ | `src/core/roster.py` | run_company_task entry point (single-entity) | `fd74c0143` |
| ✓ | `src/core/dispatcher.py` | replace _RUNNERS/_run_* with unified runner; | `fd74c0143` |
| ✓ | `src/core/gazer.py` | rename SCRAPE_ERROR_STATES | `fd74c0143` |
| ⚠ not touched | `src/ui/api/api_admin.py` | remove DISPATCH_TASKS references; update tas | — |
| ✓ | `docs/ASTRAL_CODE_RULES.md` | §2.1 + §2.6.2 | `fd74c0143` |
| + unplanned | `scripts/migrations/migrate_agent_data.py` | — | `fd74c0143` |
| + unplanned | `ui/api/api_admin.py` | — | `fd74c0143` |

...
**Linear archived:** AST-1103 2026-08-14

## Ledger

| when (PT) | ticket | phase | sha | subject |
|---|---|---|---|---|
| 2026-08-14 13:43 | AST-1103 | docs | `3e5e43aa4` | archive Linear issue content |

## Epic — AST-1103

_Archived: 2026-08-14 · Linear URL: https://linear.app/astralcareermatch/issue/AST-1103/replace-references-to-the-candidate · Status at archive: Archive · Project: Astral Agent · Assignee: susan · Priority / estimate: None / —_
